      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative">
        ...
        <div className="flex justify-center items-center mb-8 md:mb-0">
          <img
            ...
            alt="Tour Visual"
            className="max-w-full w-[90%] sm:w-[80%] md:w-[90%] lg:w-[80%] drop-shadow-lg"
          />
        </div>
        ...
        <div>
          ...
          <p className="text-gray-600 mb-10 text-sm sm:text-base md:text-lg">
          ...
          <div className="flex flex-wrap gap-4 sm:gap-6 md:gap-8 justify-center md:justify-start">
            {[
              ...
              <div key={idx} className="flex flex-col items-center w-24 sm:w-28 md:w-32">
                <CircularProgressbar
                  value={value}
                  text={`${value}%`}
                  strokeWidth={10}
