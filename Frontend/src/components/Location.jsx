...
const Location = () => {
  return (
    <section className="max-w-5xl mx-auto px-6 py-8 font-sans">
      {/* Heading */}
      ...
      <p className="text-gray-700 leading-relaxed mb-8">
        ...
        our unforgettable tour experience. Our journey begins in the vibrant city of Los Angeles, known for its
        sunny beaches, cultural diversity, and modern lifestyle. Explore the
        heart of California, from scenic drives to famous landmarks, all filled
        with unforgettable experiences.
      </p>
